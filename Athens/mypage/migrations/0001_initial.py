    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('c_no', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mypage.customer_tbl')),
                ('l_no', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mypage.lecture_tbl')),
            ],
        ),
        migrations.CreateModel(
            name='test_tbl',
            fields=[
                ...
                ('tr_no', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mypage.training_tbl')),
            ],
        ),
        migrations.CreateModel(
            name='online_tbl',
        ...
        migrations.AddField(
            ...
            name='t_no',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mypage.teacher_tbl'),
        ),
        migrations.CreateModel(
            name='consult_tbl',
            fields=[
                ...
                ('c_no', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mypage.customer_tbl')),
                ('t_no', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mypage.training_tbl')),
            ],
        ),
        migrations.CreateModel(
            name='attendance_tbl',

...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('signup', '0003_auto_20201117_1437'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('c_no', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='signup.customer_tbl')),
                ('l_no', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='signup.lecture_tbl')),
            ],
        ),
        migrations.CreateModel(
            name='test_tbl',
            fields=[
                ...
                ('tr_no', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='signup.training_tbl')),
            ],
        ),
        migrations.CreateModel(
            name='online_tbl',
        ...
        migrations.AddField(
            ...
            name='t_no',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='signup.teacher_tbl'),
        ),
        migrations.CreateModel(
            name='consult_tbl',
            fields=[
                ...
                ('c_no', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='signup.customer_tbl')),
                ('t_no', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='signup.training_tbl')),
            ],
        ),
        migrations.CreateModel(
            name='attendance_tbl',
